				...
				<div className='flex flex-col items-center'>
					...
					<div className='max-w-lg mx-auto'>
						...
						<p className='mt-4 text-center text-white/60 md:text-lg'>
							...
							challenges, I&apos;m always up for pushing the boundaries of
							what&apos;s possible online. Let&apos;s create something
							extraordinary together!
						</p>
					</div>
					<div className='flex flex-col md:flex-row justify-center items-center mt-8 gap-4'>
<<<<<<< HEAD
						<a href='/resume_said_altan_june9.pdf' download>
=======
						<a href='/Said_Altan_Resume.pdf' download>
>>>>>>> b2f6ac246b28447455ce3712055dd9f323f88c4b
